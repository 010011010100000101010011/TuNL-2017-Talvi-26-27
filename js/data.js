...
const EX = {
  ...
  c14: { n: "Seated glute lift & resisted hip thrust", p: "core", v: ["V5", 5], focus: "Hip extensors/rotators, deep abs, lumbar stabilisers", cues: ["Lower slowly, light hip touch to floor", "Drive up thrusting hips forward, hold weight stable on hips"], prog: "Light bag on hips (U12: a filled backpack)" },
  ...
  p05: { n: "Single-leg lateral counter jumps L↔R (light load)", p: "power", v: ["V4", 5], focus: "Lateral + single-leg power, landing stabilisers", cues: ["Drive laterally for max distance", "Quick counter back to start", "U12 load = light backpack only, and only when unloaded is clean"], prog: "Increased rotation (arms beyond landing line)" },
  ...
  x01: { n: "Curtsy squat → side lunge", p: "combo", v: null, focus: "Knee/hip extensors, glute med of curtsy leg, adductors + deep core", cues: ["Big step out to the side, other leg straight", "Cross back leg behind, knee toward floor on the ball of the foot", "Drive up INTO the side lunge", "U12: bodyweight first; resistance (partner hand / bag) at chest height only when perfect"], prog: "Add light resistance once bodyweight is clean" },
